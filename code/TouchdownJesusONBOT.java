...
@TeleOp(name="TouchdownJesusONBOT", group="Test")
public class TouchdownJesusONBOT extends OpMode {
    ...
    public void loop() {
        ...
        if (strafeCheck == true && (gamepad1.dpad_left || gamepad1.left_stick_x < 0 || gamepad1.right_stick_x < 0)) {
            //Strafe Right
        ...
        } else if (strafeCheck == true && (gamepad1.dpad_right || gamepad1.left_stick_x > 0 || gamepad1.right_stick_x > 0)) {
            //Strafe Left
            robot.FrontRight.setPower(-STRAFE_POWER * 1.1);
            robot.RearRight.setPower(STRAFE_POWER);
